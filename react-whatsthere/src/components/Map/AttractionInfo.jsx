...
export default function AttractionInfo({
  ...
  return (
    <div
      ...
      } bg-white p-4  rounded-md shadow-md w-[100%] h-[100%] overflow-y-auto`}
      style={{ backdropFilter: "none", transform: "scale(0.8)" }}
    >
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={handleClose}>
          <FontAwesomeIcon icon={faSquareXmark} className="scale-150" />
        </button>
      </div>
      {currentAttraction && (
        <>
            ...
            <div className="p-3">
              <div>
                ...
                <div className="mb-2">
                  ...
                  {currentAttraction.subtype[0].name}
                </div>
                <div className="mb-2">
