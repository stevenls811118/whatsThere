      ...
      <div className="flex flex-row space-x-2 justify-around">
        <div>
          <button
            ...
            className="border-double border-2 border-blue-500 rounded-2xl p-2 font-bold bg-blue-500 w-28 text-center text-white"
          >
            Save
          </button>
        </div>
        <div>
          <button
            ...
            className="border-double border-2 border-white rounded-2xl p-2 font-bold bg-grey-600 w-28 text-center"
          >
            Cancel
          </button>
        </div>
