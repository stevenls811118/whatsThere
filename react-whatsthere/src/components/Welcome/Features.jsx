      ...
      <div className=" h-full w-full ">
        <section className="flex flex-col justify-around h-full p-4 text-white space-y-3 text-center">
          <article className="p-4 bg-black/50">
            <h1 className="text-center text-lg font-bold pb-1">Interactive Map</h1>
            <p>
          ...
          <article className="p-4 bg-black/50">
            <h1 className="text-center text-lg font-bold pb-1">Multiple Trip Lists</h1>
            <p>
          ...
          <article className="p-4 bg-black/50">
            <h1 className="text-center text-lg font-bold pb-1">Upcoming Visit Alerts</h1>
            <p>
